        ...
        <nav>
          <ul>
            <li>
              ...
              <Tooltip id="tooltip-horoscope-link" style={{ backgroundColor: 'rgb(75, 75, 75)', fontSize: '10px' }} />
            </li>
            <li>
              <Link
              ...
              <Tooltip id="tooltip-numerology-link" style={{ backgroundColor: 'rgb(75, 75, 75)', fontSize: '10px' }} />
            </li>
          </ul>
        </nav>
      </div>
